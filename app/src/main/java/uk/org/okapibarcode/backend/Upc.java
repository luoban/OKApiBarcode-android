    ...
    protected void plotSymbol() {
        ...
        for (xBlock = 0; xBlock < pattern[0].length(); xBlock++) {
            if (black) {
                ...
                RectF rect = new RectF(x + 6, y + compositeOffset, w, h);
                rectangles.add(rect);
        ...
        if (linkageFlag) {
            ...
            if (mode == Mode.UPCA) {
                rectangles.add(new RectF(0 + 6, 0, 1, 2));
                rectangles.add(new RectF(94 + 6, 0, 1, 2));
                rectangles.add(new RectF(-1 + 6, 2, 1, 2));
                rectangles.add(new RectF(95 + 6, 2, 1, 2));
            } else { // UPCE
                rectangles.add(new RectF(0 + 6, 0, 1, 2));
                rectangles.add(new RectF(50 + 6, 0, 1, 2));
                rectangles.add(new RectF(-1 + 6, 2, 1, 2));
                rectangles.add(new RectF(51 + 6, 2, 1, 2));
            }
        }
