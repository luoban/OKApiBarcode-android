...
public class Composite extends Symbol {
    ...
    public boolean encode() {
        List < RectF > linear_rect = new ArrayList<>();
        List < TextBox > linear_txt = new ArrayList<>();
        List <RectF> combine_rect = new ArrayList<>();
        ...
        for (i = 0; i < rectangles.size(); i++) {
            RectF comprect = new RectF(rectangles.get(i).left + top_shift, rectangles.get(i).top, rectangles.get(i).width(), rectangles.get(i).height());
            if ((rectangles.get(i).left + top_shift + rectangles.get(i).width()) > max_x) {
                max_x = (int) (rectangles.get(i).left + top_shift + rectangles.get(i).width());
            }
            combine_rect.add(comprect);
        }

        for (i = 0; i < linear_rect.size(); i++) {
            RectF linrect = new RectF(linear_rect.get(i).left + bottom_shift, linear_rect.get(i).top, linear_rect.get(i).width(), linear_rect.get(i).height());
            linrect.top += symbol_height;
            if ((linear_rect.get(i).left + bottom_shift + linear_rect.get(i).width()) > max_x) {
                max_x = (int) (linear_rect.get(i).left + bottom_shift + linear_rect.get(i).width());
            }
